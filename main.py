...
def main():
    ...
    parser.add_argument('--max_len', type=int, default=50, help='maximum characters of sentence (default: 80)')
    ...
    nsml.load(checkpoint='best0_03913475103192434', session='team39/sr-hack-2019-50000/117')
    nsml.save('saved')
    if args.pause == 1:
